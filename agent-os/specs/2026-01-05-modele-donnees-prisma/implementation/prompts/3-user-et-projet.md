We're continuing our implementation of Modèle de données & Prisma by implementing task group number 3:
...
- [ ] 3.0 Créer les modèles User et Projet
  - [ ] 3.1 Modèle User
